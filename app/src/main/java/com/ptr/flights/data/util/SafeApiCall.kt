package com.ptr.flights.data.util

import com.ptr.flights.data.constant.Constants.CONNECT_EXCEPTION
import com.ptr.flights.data.constant.Constants.GENERAL_ERROR
import com.ptr.flights.data.constant.Constants.SOCKET_TIME_OUT_EXCEPTION
import com.ptr.flights.data.constant.Constants.UNKNOWN_HOST_EXCEPTION
import com.ptr.flights.data.constant.Constants.UNKNOWN_NETWORK_EXCEPTION
